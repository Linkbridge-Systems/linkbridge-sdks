...
func main() {
    ...
    accepted, err := client.Invoices.Submit(ctx, oapi.Invoice{
        // canonical NRS invoice — see packages/schema/invoice.schema.json
        "irn": "INV-2024-0001",
        // ...
    }, linkbridge.SubmitOptions{})
    if err != nil { log.Fatal(err) }
...
- `StaticToken` — useful for tests against the bootstrap-bearer dev
  mode of the API server.
