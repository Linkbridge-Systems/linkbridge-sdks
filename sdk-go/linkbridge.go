...
type Config struct {
	...
	// token verbatim. Useful for tests against the bootstrap-bearer
	// dev mode of the API.
	StaticToken string
...
func New(ctx context.Context, cfg Config) (*Client, error) {
	...
	// Token source. Static tokens take precedence — useful for tests
	// and the legacy bootstrap-bearer dev mode of the api server.
	if cfg.StaticToken != "" {
