...
export interface ClientConfig {
  ...
  clientId?: string;
  clientSecret?: string;
  /** Bypass OAuth2 — useful for tests / dev bootstrap-bearer mode. */
  staticToken?: string;
...
export class InvoicesAPI {
  ...
  submit(payload: Invoice, opts: SubmitOptions = {}): Promise<InvoiceAccepted> {
    return this.client.request<InvoiceAccepted>("POST", "/v1/invoices", {
...
export type { Invoice, InvoiceAccepted, InvoiceRecord, InvoicePage, InvoiceStatus, Webhook, WebhookCreate };
